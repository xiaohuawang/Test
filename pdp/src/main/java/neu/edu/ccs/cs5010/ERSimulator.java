...
//	PatientGeneratorFixTest pg = new PatientGeneratorFixTest();
		...
		public void run() {
			...
			try {
				while (true){
					...
					if(patientIndex==pg.totalPatientNumber){
...
//			System.out.println("come empty"); 
		...
		public void patientPQTest() {
			...
			for (int i = 0; i < pg.totalPatientNumber; i++) {
...
//
//		    case "p":
//		        return new PatientGeneratorFixTest();
//
//		    case "r":
//		        return new PatientGeneratorRandom();
//		    }
			return input;
		}
